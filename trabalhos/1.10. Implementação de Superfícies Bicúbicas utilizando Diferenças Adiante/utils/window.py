...
class Window():
      ...
      def zomOut(self):
            ...
            #Gera matriz de translação para o ponto inicial.
            matrix_transition_initial = Transform.translation3D(self.x_center,self.y_center,self.y_center)
      ...
      def moveUp(self):
            ...
            matrix = Transform.translation3D(0, 10, 0)
      ...
      def moveLeft(self):
            #Gera matriz de translação.
            matrix = Transform.translation3D(-10, 0, 0)
