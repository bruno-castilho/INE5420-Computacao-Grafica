...
class NewObject(Frame):
    ...
    def __init__(self, mainframe):
        ...
        self.objects['values'] = ('point','line', 'wireframe','Bézier Curve', 'B-splines', 'Surfaces Bézier', 'Surfaces FwdDiff')
    ...
    def create(self):
        ...
        if self.objects.get() == 'Surfaces Bézier':
            top.createBezierSurfaces(viewport)
        if self.objects.get() == 'Surfaces FwdDiff':
            top.createSurfaceFwdDiff(viewport)
