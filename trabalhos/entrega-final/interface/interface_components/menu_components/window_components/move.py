...
class Move(Frame):
    ...
    def __init__(self, mainframe):
        #Set frame move
        Frame.__init__(self, mainframe, background="#9b9b9b", width=180, height=130)
        ...
        self.text.grid(column=0,row=0, columnspan=3, sticky='nwes')
        
        self.d = Entry(self, width=3,justify=CENTER)
        self.d.grid(column=1,row=2, sticky='nwes')
        self.d.insert(0,'10')
    ...
    def moveUp(self, viewport):
        ...
        window.moveUp(float(self.d.get()))
        #Redesenha os objetos na viewport.
        viewport.draw()
    
    def moveLeft(self, viewport):
        #Move a window para cima.
        window.moveLeft(float(self.d.get()))
        #Redesenha os objetos na viewport.
        viewport.draw()
    
    def moveRight(self, viewport):
        #Move a window para cima.
        window.moveRight(float(self.d.get()))
        #Redesenha os objetos na viewport.
        viewport.draw()
    
    def moveDown(self, viewport):
        #Move a window para cima.
        window.moveDown(float(self.d.get()))
        #Redesenha os objetos na viewport.
        viewport.draw()